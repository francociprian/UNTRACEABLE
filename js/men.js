...
const productosMen = document.getElementById('menList')
...
function cargarEventos() {
	...
	productosMen.addEventListener("click", (e) => {
...
async function fetchProductos() {
    ...
    const data = product.men
    data.forEach(producto => {
        productosMen.innerHTML = "";
    ...
    productosMen.appendChild(fragment);
}
